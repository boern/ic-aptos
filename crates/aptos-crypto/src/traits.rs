...
use super::ed25519;
use super::hash::{CryptoHash, CryptoHasher};
use anyhow::Result;
...
pub(crate) mod private {
    ...
    impl Sealed for super::ed25519::Ed25519PrivateKey {}
    impl Sealed for super::ed25519::Ed25519PublicKey {}
    impl Sealed for super::ed25519::Ed25519Signature {}
